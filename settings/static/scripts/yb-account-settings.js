...
$(document).ready(function(){
    ...
    //Handle input change
    var original_fname = $("#field-first-name").val();
    ...
    var original_lname = $("#field-last-name").val();
    ...
    var original_email = $("#field-email-address").val();
    ...
    var original_phone = $("#field-phone-number").val();
    ...
    var original_username = $("#field-username").val();
