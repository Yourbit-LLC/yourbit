...
from user_profile.models import Custom, Bit
...
class Notification(models.Model):
    ...
    custom = models.ForeignKey(Custom, on_delete=models.CASCADE, related_name='+', blank=True, null=True)
    ...
    conversation = models.ForeignKey('messenger.Conversation', on_delete=models.CASCADE, related_name='+', blank=True, null=True)