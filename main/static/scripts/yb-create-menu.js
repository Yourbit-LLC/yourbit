...
$('.create-option').click(function() {
    ...
    if (option === 'chat' ){
        ...
        let to_field = yb_createElement("input", "mobile-to", "single-line-input");
        let title_field = yb_createElement("input", "mobile-title", "single-line-input");
        let body_field = yb_createElement("input", "mobile-body", "single-line-input"); 
        ...
        //Attach script
        script_source.src = "/static/scripts/yb-create-bit.js";
    ...
    if (option === 'video'){
        ...
        form.innerHTML = `
            ...
            <textarea class='yb-text-area' id="mobile-bit-body" placeholder="Info" style="color:white; font-size: 14px;"></textarea>
    ...
    if (option === 'community'){
        ...
        //change form fields to correspond with creation
        form.innerHTML = `
            <input type="text" class="single-line-input" id="mobile-community-name" placeholder="Name" style="color:white; font-size: 16px; font-weight: 600;"><br><br>
            <input type="text" class="single-line-input" id="mobile-community-handle" placeholder="Handle" style="color:white; font-size: 16px; font-weight: 600;">
            <br><br>
        `;
    ...
    if (option === 'message'){
        $('#create-bit-header-text').html('Send a Message');
        $('#create-options').fadeOut();
        $('#create-container').fadeIn();
        option_field.value = 'message';
        form.innerHTML = `
        <input type="text" class="single-line-input" id="mobile-to" placeholder="Name" style="color:white; font-size: 16px; font-weight: 600;"><br><br>
        <textarea id="mobile-body" class='yb-text-area' placeholder="Body" style="color:white; font-size: 14px;"></textarea>
        <br><br>
        `;
