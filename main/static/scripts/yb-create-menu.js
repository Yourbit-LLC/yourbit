...
let back_button = document.getElementById("back-create");
...
function yb_chatBitForm(form, type_field, option_field, script_source) {
        ...
        //Attach script
        script_source.src = "https://objects-in-yourbit.us-southeast-1.linodeobjects.com/scripts/yb-create-bit.js";
...
$('.create-option').click(function() {
    ...
    if (option === 'community'){
        ...
        script_source.src = "https://objects-in-yourbit.us-southeast-1.linodeobjects.com/scripts/yb-create-community.js"
    }
