...
function yb_closeBitOption(this_element, action) {
    ...
    if (action === "schedule"){
        ...
        let monetize_menu = document.getElementById("monetize-menu");
        monetize_menu.remove();
        ...
        let enhance_menu = document.getElementById("enhance-menu");
        enhance_menu.remove();
