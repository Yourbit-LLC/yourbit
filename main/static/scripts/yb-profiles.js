...
function yb_BuildProfile(profile_data){
    ...
    if (active_id != user_id){
        let profile_button_connect = yb_createElement("button", "button-profile-interaction", "button-profile-interaction");
        ...
        profile_button_connect.addEventListener("click", function(){
            ...
            profile_interaction_container.appendChild(dropdown);
    ...
    profile_button_about.innerHTML = "About Me";
